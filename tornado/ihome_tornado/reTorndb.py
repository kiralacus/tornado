...
class HostDao:
    ...
    def update_worker_num_by_hostname(self, hostname, worker_num):
        try:
            ...
            logging.error("Update Host failed! Exception: %s   hostname: %s , worker_num: %s", str(ex), str(hostname),
                          worker_num)
            return None
    ...
    def update_worker_num_by_id(self, host_id, worker_num):
        try:
            ...
            logging.error("Update Host failed! Exception: %s   host_id: %s , worker_num: %s", str(ex), host_id,
                          worker_num)
            return None
